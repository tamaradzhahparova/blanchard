...
document
  ...
  .addEventListener("click", (ev) => {
    ...
    document
      ...
      .classList.add("header-block_active");
  });
...
document
  ...
  .addEventListener("click", (ev) => {
    ...
    document
      .querySelector(".header-block")
      .classList.remove("header-block_active");
  });
...
const select = document
  .querySelectorAll(".gallery-filter__select")
  .forEach((select) => {
...
document.querySelectorAll(".catalog-tabs__btn").forEach((tabsBtn) => {
  tabsBtn.addEventListener("click", (ev) => {
    ...
    document
      .querySelector(`[data-target="${path}"] .catalog-artist`)
      .classList.add("catalog-artist_active");
    const btnPath = document.querySelector(
      `[data-target="${path}"] .catalog-artist_active`
    ).dataset.target;

    //удаляем класс активности со всех кнопок
    document
      .querySelectorAll(".catalog-accordeon__artist-btn")
      .forEach((buttons) => {
    ...
    document
      .querySelector(`[data-path="${btnPath}"]`)
      .classList.add("artist-btn_active");
  });
});
...
const spoiler = () => {
  ...
  document
    .querySelector(".editions-subtitle_category")
    .addEventListener("click", (ev) => {
      document
        .querySelector(".editions-subtitle__btn")
        .classList.toggle("editions-subtitle__btn_active");

      document
        .querySelectorAll(".editions-category__item")
        .forEach((category) => {
